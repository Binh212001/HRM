...
public interface OverTimeRepository extends JpaRepository<Overtime, String> {
    ...
    @Query(value = "SELECT new com.example.hrm.models.OverTimeModel(o.id, e.employeeCode, o.date, o.reason, o.status,e.fullName,o.startTime,o.endTime, o.actualHours) FROM Overtime o INNER JOIN Employee as e on e.employeeCode = o.employee.employeeCode" )
    List<OverTimeModel> getAllOT(Pageable pageable);
